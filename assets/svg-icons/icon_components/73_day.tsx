...
const Svg73Day = (props: WeatherIconProps) => {
  ...
  return (
      ...
      >
        ...
        />
        <Path
            d="M60,18c1.104,0,2-0.896,2-2v-4c0-1.104-0.896-2-2-2s-2,0.896-2,2v4C58,17.104,58.896,18,60,18z"
            fill={fill}
        />
        <Path
