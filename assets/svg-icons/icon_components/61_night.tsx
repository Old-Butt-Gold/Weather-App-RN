...
const Svg61Night = (props: MyIconProps) => {
  ...
  return (
      ...
      >
        <Path
            d="M46.481,52.698c-0.663,0.774-6.48,7.723-6.481,13.301c-0.001,2.063,0.712,4,2.006,5.455
...
export default memo(Svg61Night);
