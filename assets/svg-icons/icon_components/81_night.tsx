...
const Svg81Night = (props: WeatherIconProps) => {
  ...
  return (
      ...
      >
        ...
        />
        <Path
            d="M39.6,58.8c-0.754-1.006-2.445-1.006-3.199,0C35.602,59.863,33,63.525,33,66c0,2.944,2.056,5,5,5c2.944,0,5-2.056,5-5
			C43,63.525,40.397,59.863,39.6,58.8z"
            fill={fill}
        />
        <Path
            d="M56.4,58.8C55.602,59.863,53,63.525,53,66c0,2.944,2.056,5,5,5c2.944,0,5-2.056,5-5c0-2.475-2.603-6.137-3.4-7.2
			C58.846,57.794,57.154,57.794,56.4,58.8z"
            fill={fill}
        />
        <Path
            d="M46.4,70.8C45.602,71.863,43,75.525,43,78c0,2.944,2.056,5,5,5c2.944,0,5-2.056,5-5c0-2.475-2.603-6.137-3.4-7.2
...
export default memo(Svg81Night);
