...
const Svg77Day = (props: WeatherIconProps) => {
  ...
  return (
      ...
      >
        <Path
            d="M72.555,42.188c0.945-1.915,1.444-4.021,1.444-6.188c0-7.72-6.28-14-14-14c-4.601,0-8.895,2.281-11.496,6.021
        ...
        />
        <Path
            d="M83.999,34h-4c-1.105,0-2,0.896-2,2s0.895,2,2,2h4c1.104,0,2-0.896,2-2S85.103,34,83.999,34z"
            fill={fill}
        />
        <Path
        ...
        />
        <Path
            d="M45.732,62.464c-0.554-0.956-1.773-1.286-2.732-0.733c-0.956,0.553-1.284,1.775-0.732,2.732l1,1.732
			c0.371,0.642,1.043,1,1.734,1c0.339,0,0.683-0.086,0.998-0.268c0.956-0.553,1.284-1.775,0.732-2.732L45.732,62.464z"
            fill={fill}
        />
        <Path
            d="M40.732,53.804c-0.554-0.957-1.774-1.285-2.732-0.732c-0.956,0.553-1.284,1.775-0.732,2.732l1,1.732
			c0.371,0.642,1.043,1,1.734,1c0.339,0,0.683-0.086,0.998-0.267c0.956-0.553,1.284-1.775,0.732-2.733L40.732,53.804z"
            fill={fill}
        />
        <Path
            d="M43,58.269c0.315,0.182,0.659,0.267,0.998,0.267c0.691,0,1.363-0.358,1.734-1l1-1.732c0.552-0.957,0.224-2.18-0.732-2.732
			c-0.96-0.553-2.18-0.225-2.732,0.732l-1,1.732C41.716,56.493,42.044,57.716,43,58.269z"
            fill={fill}
        />
        <Path
            d="M41,61.731c-0.96-0.554-2.18-0.224-2.732,0.733l-1,1.732c-0.552,0.957-0.224,2.18,0.732,2.732
			c0.315,0.182,0.659,0.268,0.998,0.268c0.691,0,1.363-0.358,1.734-1l1-1.732C42.284,63.507,41.956,62.284,41,61.731z"
            fill={fill}
        />
        <Path
            d="M40,60c0-1.104-0.896-2-2-2h-2c-1.105,0-2,0.896-2,2s0.895,2,2,2h2C39.104,62,40,61.104,40,60z"
            fill={fill}
        />
        <Path
            d="M50,60c0-1.104-0.896-2-2-2h-2c-1.105,0-2,0.896-2,2s0.895,2,2,2h2C49.104,62,50,61.104,50,60z"
            fill={fill}
        />
        <Path
            d="M60.732,71.268c-0.554-0.956-1.773-1.285-2.732-0.732c-0.956,0.553-1.284,1.775-0.732,2.732l1,1.732
			c0.371,0.642,1.043,1,1.734,1c0.339,0,0.683-0.086,0.998-0.268c0.956-0.553,1.284-1.775,0.732-2.732L60.732,71.268z"
            fill={fill}
        />
        <Path
            d="M55.732,62.607c-0.554-0.956-1.773-1.286-2.732-0.732c-0.956,0.553-1.284,1.775-0.732,2.732l1,1.732
			c0.371,0.642,1.043,1,1.734,1c0.339,0,0.683-0.086,0.998-0.267c0.956-0.553,1.284-1.775,0.732-2.733L55.732,62.607z"
            fill={fill}
        />
        <Path
            d="M58,67.072c0.315,0.182,0.659,0.267,0.998,0.267c0.691,0,1.363-0.358,1.734-1l1-1.732c0.552-0.957,0.224-2.18-0.732-2.732
			c-0.96-0.554-2.181-0.224-2.732,0.732l-1,1.732C56.716,65.297,57.044,66.52,58,67.072z"
            fill={fill}
        />
        <Path
            d="M56,70.535c-0.96-0.553-2.181-0.224-2.732,0.732l-1,1.732c-0.552,0.957-0.224,2.18,0.732,2.732
			C53.315,75.914,53.659,76,53.998,76c0.691,0,1.363-0.358,1.734-1l1-1.732C57.284,72.311,56.956,71.088,56,70.535z"
            fill={fill}
        />
        <Path
            d="M55,68.804c0-1.104-0.896-2-2-2h-2c-1.105,0-2,0.896-2,2s0.895,2,2,2h2C54.104,70.804,55,69.908,55,68.804z"
            fill={fill}
        />
        <Path
            d="M63,66.804h-2c-1.105,0-2,0.896-2,2s0.895,2,2,2h2c1.104,0,2-0.896,2-2S64.104,66.804,63,66.804z"
            fill={fill}
        />
      </Svg>
  );
