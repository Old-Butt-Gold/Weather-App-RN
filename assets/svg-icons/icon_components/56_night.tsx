...
const Svg56Night = (props: WeatherIconProps) => {
  ...
  return (
      ...
      >
        ...
        />
        <Path
            d="M48,66c-1.104,0-2,0.896-2,2v4c0,1.104,0.896,2,2,2s2-0.896,2-2v-4C50,66.896,49.104,66,48,66z"
            fill={fill}
        />
        <Path
            d="M48,78c-1.104,0-2,0.896-2,2v4c0,1.104,0.896,2,2,2s2-0.896,2-2v-4C50,78.896,49.104,78,48,78z"
            fill={fill}
        />
        <Path
            d="M39,72c-1.104,0-2,0.896-2,2v4c0,1.104,0.896,2,2,2c1.104,0,2-0.896,2-2v-4C41,72.896,40.104,72,39,72z"
            fill={fill}
        />
        <Path
            d="M57,72c-1.104,0-2,0.896-2,2v4c0,1.104,0.896,2,2,2c1.104,0,2-0.896,2-2v-4C59,72.896,58.104,72,57,72z"
            fill={fill}
        />
      </Svg>
  );
...
export default memo(Svg56Night);
